...
/// @nodoc
abstract mixin class $FuneralModelCopyWith<$Res>  {
  factory $FuneralModelCopyWith(FuneralModel value, $Res Function(FuneralModel) _then) = _$FuneralModelCopyWithImpl;
@useResult
$Res call({
 String id, String deceasedName, String gender, String mosqueName, String mosqueLocation, double lat, double lng,@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime prayerTime, String publisherId, bool isMosqueVerified,@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime createdAt, String? fatherName, String? burialLocation, String? ageType, String? funeralNotes, String? notes, String? photoUrl, int? prayedCount, int? reportCount
});
...
/// @nodoc
class _$FuneralModelCopyWithImpl<$Res>
    implements $FuneralModelCopyWith<$Res> {
  _$FuneralModelCopyWithImpl(this._self, this._then);

  final FuneralModel _self;
  final $Res Function(FuneralModel) _then;
...
/// Adds pattern-matching-related methods to [FuneralModel].
extension FuneralModelPatterns on FuneralModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FuneralModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FuneralModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FuneralModel value)  $default,){
final _that = this;
switch (_that) {
case _FuneralModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FuneralModel value)?  $default,){
final _that = this;
switch (_that) {
case _FuneralModel() when $default != null:
return $default(_that);case _:
...
class _FuneralModel extends FuneralModel {
  const _FuneralModel({required this.id, required this.deceasedName, required this.gender, required this.mosqueName, required this.mosqueLocation, required this.lat, required this.lng, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) required this.prayerTime, required this.publisherId, required this.isMosqueVerified, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) required this.createdAt, this.fatherName, this.burialLocation, this.ageType, this.funeralNotes, this.notes, this.photoUrl, this.prayedCount, this.reportCount}): super._();
  factory _FuneralModel.fromJson(Map<String, dynamic> json) => _$FuneralModelFromJson(json);
...
@override@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) final  DateTime prayerTime;
...
@pragma('vm:prefer-inline')
_$FuneralModelCopyWith<_FuneralModel> get copyWith => __$FuneralModelCopyWithImpl<_FuneralModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$FuneralModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FuneralModel&&(identical(other.id, id) || other.id == id)&&(identical(other.deceasedName, deceasedName) || other.deceasedName == deceasedName)&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.mosqueName, mosqueName) || other.mosqueName == mosqueName)&&(identical(other.mosqueLocation, mosqueLocation) || other.mosqueLocation == mosqueLocation)&&(identical(other.lat, lat) || other.lat == lat)&&(identical(other.lng, lng) || other.lng == lng)&&(identical(other.prayerTime, prayerTime) || other.prayerTime == prayerTime)&&(identical(other.publisherId, publisherId) || other.publisherId == publisherId)&&(identical(other.isMosqueVerified, isMosqueVerified) || other.isMosqueVerified == isMosqueVerified)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.fatherName, fatherName) || other.fatherName == fatherName)&&(identical(other.burialLocation, burialLocation) || other.burialLocation == burialLocation)&&(identical(other.ageType, ageType) || other.ageType == ageType)&&(identical(other.funeralNotes, funeralNotes) || other.funeralNotes == funeralNotes)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.photoUrl, photoUrl) || other.photoUrl == photoUrl)&&(identical(other.prayedCount, prayedCount) || other.prayedCount == prayedCount)&&(identical(other.reportCount, reportCount) || other.reportCount == reportCount));
}
...
/// @nodoc
abstract mixin class _$FuneralModelCopyWith<$Res> implements $FuneralModelCopyWith<$Res> {
  factory _$FuneralModelCopyWith(_FuneralModel value, $Res Function(_FuneralModel) _then) = __$FuneralModelCopyWithImpl;
@override @useResult
$Res call({
 String id, String deceasedName, String gender, String mosqueName, String mosqueLocation, double lat, double lng,@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime prayerTime, String publisherId, bool isMosqueVerified,@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime createdAt, String? fatherName, String? burialLocation, String? ageType, String? funeralNotes, String? notes, String? photoUrl, int? prayedCount, int? reportCount
});
...
/// @nodoc
class __$FuneralModelCopyWithImpl<$Res>
    implements _$FuneralModelCopyWith<$Res> {
  __$FuneralModelCopyWithImpl(this._self, this._then);

  final _FuneralModel _self;
  final $Res Function(_FuneralModel) _then;

/// Create a copy of FuneralModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? deceasedName = null,Object? gender = null,Object? mosqueName = null,Object? mosqueLocation = null,Object? lat = null,Object? lng = null,Object? prayerTime = null,Object? publisherId = null,Object? isMosqueVerified = null,Object? createdAt = null,Object? fatherName = freezed,Object? burialLocation = freezed,Object? ageType = freezed,Object? funeralNotes = freezed,Object? notes = freezed,Object? photoUrl = freezed,Object? prayedCount = freezed,Object? reportCount = freezed,}) {
  return _then(_FuneralModel(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,deceasedName: null == deceasedName ? _self.deceasedName : deceasedName // ignore: cast_nullable_to_non_nullable
as String,gender: null == gender ? _self.gender : gender // ignore: cast_nullable_to_non_nullable
as String,mosqueName: null == mosqueName ? _self.mosqueName : mosqueName // ignore: cast_nullable_to_non_nullable
